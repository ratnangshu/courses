...
for ang = 1:1:45
    ...
    % Minimum Energy
    %Fmin = calcForce(i, theta_i_val, theta_n_val, phi_i_val, phi_n_val, 0, alpha_n, eta_temp, 1);
    ...
    % Armarego
    %Farm = calcForce(i, 0, beta_n_a-alpha_n, 0, phi_n_a, beta_n_a, alpha_n, eta_temp_a, 0);
    ...
    % simplified Armarego
    %Fsim = calcForce(i, 0, beta_n_s-alpha_n, 0, phi_n_s, beta_n_s, alpha_n, eta_s, 0);
...
% annotation('textbox',[0.65 0.575 .15 .4],'BackgroundColor','w');
% annotation('textbox',[0.65 0.65 .3 .3],'String','\bullet Minimum Energy Principle','FitBoxToText','on','EdgeColor','none','color','b');
% annotation('textbox',[0.65 0.55 .3 .3],'String','\bullet Armarego Model','FitBoxToText','on','EdgeColor','none','color','r');
% annotation('textbox',[0.65 0.45 .3 .3],'String','\bullet Simplified Armarego Model','FitBoxToText','on','EdgeColor','none','color','m');
% annotation('textbox',[0.65 0.35 .3 .3],'String','* Lin & Oxley (1972)','FitBoxToText','on','EdgeColor','none','color','k');
...
%annotation('textbox',[0.825 0.575 .15 .4],'BackgroundColor','w');
annotation('textbox',[0.825 0.8 .15 .15],'BackgroundColor','w');
%annotation('textbox',[0.825 0.675 .3 .3],'String','U: Cutting Velocity in m/min','FitBoxToText','on','EdgeColor','none','color','k');
%annotation('textbox',[0.825 0.6 .3 .3],'String','* U = 7.62 m/min','FitBoxToText','on','EdgeColor','none','color',colors(1,:));
%annotation('textbox',[0.825 0.55 .3 .3],'String','* U = 60.96 m/min','FitBoxToText','on','EdgeColor','none','color',colors(2,:));
%annotation('textbox',[0.825 0.5 .3 .3],'String','* U = 121.92 m/min','FitBoxToText','on','EdgeColor','none','color',colors(3,:));
...
%annotation('textbox',[0.825 0.45 .3 .3],'String','* U = 182.88 m/min','FitBoxToText','on','EdgeColor','none','color',colors(4,:));
%annotation('textbox',[0.825 0.4 .3 .3],'String','* U = 243.84 m/min','FitBoxToText','on','EdgeColor','none','color',colors(5,:));
%annotation('textbox',[0.825 0.35 .3 .3],'String','* U = 304.8 m/min','FitBoxToText','on','EdgeColor','none','color',colors(6,:));